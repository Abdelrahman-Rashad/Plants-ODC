...
class SignInWidget extends StatelessWidget {
  SignInWidget({Key? key, required this.controller, required this.formkey})
      : super(key: key);
            ...
            child: ElevatedButton(
                onPressed: () {
                  if (formkey.currentState!.validate()) {
                    controller.signInController(controller.email.text.trim(),
            ...
            children: [
              Padding(
                ...
                child: GestureDetector(
                  onTap: (){controller.signInWithGoogleController();},
                  child: Image.asset(
